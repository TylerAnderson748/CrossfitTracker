...
export const EQUIPMENT_CATALOG: CatalogGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "seated_row_machine", label: "Seated row machine" },
      { key: "leg_extension", label: "Leg extension machine" },
      { key: "leg_curl", label: "Leg curl machine" },
      { key: "hip_thrust_machine", label: "Hip thrust machine" },
      { key: "calf_raise_machine", label: "Calf raise machine" },
      ...
      { key: "assisted_pullup_machine", label: "Assisted pull-up machine" },
